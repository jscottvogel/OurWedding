...
export function HeroSection({ wedding }: { wedding?: Schema['Wedding']['type'] | null }) {
  ...
  return (
    <section id="hero" className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-charcoal">
      <div 
  ...
  return (
    <section id="story" className="py-32 px-4 max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="prose prose-lg font-body text-gray-700 leading-relaxed whitespace-pre-wrap">
          {story.coupleStory}
        </div>
      </div>
    </section>
...
export function WeddingPartySection({ partyMembers }: { partyMembers?: Schema['WebsitePartyMember']['type'][] }) {
  ...
  return (
    <section id="party" className="py-20 bg-ivory/30">
